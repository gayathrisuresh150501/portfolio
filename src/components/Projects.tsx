  ...
  const projects = [
    {
      ...
      description:
        'Engineered a high-performance 2D grid-based racing engine in Go, utilizing a terminal-based UI (TUI) to simulate real-time car movement and telemetry within a coordinated grid system. Implemented a highly concurrent execution model using Goroutines and Channels to manage independent AI racing agents, achieving thread-safe state synchronization and sub-10ms frame rendering. Optimized memory usage and execution speed by minimizing allocations in the simulation loop, ensuring stable performance across long-duration race scenarios.',
    ...
    },
    {
      title: 'Coming Soon',
      timeline: 'TBD',
      description: 'Upcoming project - details to be added.',
      technologies: [],
      github: null,
    },
    {
